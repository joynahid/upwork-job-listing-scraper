...
import { footerData, socialLinks } from "@/data/landing";

export function Footer() {
  return (
    <footer className="bg-base-200/50 border-t border-base-300/20">
      <Container>
        {/* Main Footer Content */}
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-base-content/70 mb-6 max-w-sm">{footerData.company.description}</p>

              {/* Newsletter Signup */}
              <div className="space-y-3">
                <h4 className="font-semibold">{footerData.newsletter.title}</h4>
                <p className="text-sm text-base-content/70">{footerData.newsletter.description}</p>
